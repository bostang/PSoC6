...
void oled_task(void* arg)
{
	...
	handle_error(result);
		...
		for(;;)
		{
			...
			{
				// tunggu tiga detik lalu tampilkan tag pada OLED
//				vTaskDelay(pdMS_TO_TICKS(4*BLINKING_DELAY_MS)) ;
...
//				GUI_DispStringAt(hexStringArray,0,16,2); // Display tag value
				GUI_DispDecAt(1729,0,16,2); // Display tag value
