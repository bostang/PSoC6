...
size_t l_cmd_setFreqRegion = sizeof(cmd_setFreqRegion);
size_t l_cmd_setFreqCh = sizeof(cmd_setFreqCh);
size_t l_cmd_autoFreqHop = sizeof(cmd_autoFreqHop);
size_t l_cmd_PowEmmCap = sizeof(cmd_PowEmmCap);
size_t l_cmd_startSingleRead = sizeof(cmd_startSingleRead);
size_t l_cmd_setWorkParam = sizeof(cmd_setWorkParam);
size_t l_cmd_startRead = sizeof(cmd_startRead);
size_t l_cmd_stopRead = sizeof(cmd_stopRead);
...
//    size_t       rx_length = RX_BUF_SIZE;
    ...
    // Inisiasi uart object
    result = cyhal_uart_init(&uart_obj, RFID_tx, RFID_rx, NC, NC, NULL, &uart_config);
...
//			printf("panjang cmd_readDevice : %d \r\n",l_cmd_readDevice);
//			printf("panjang cmd_setFreqRegion : %d \r\n",l_cmd_setFreqRegion);
//			printf("panjang cmd_setFreqCh : %d \r\n",l_cmd_setFreqCh);
//			printf("panjang cmd_autoFreqHop : %d \r\n",l_cmd_autoFreqHop);
//			printf("panjang cmd_PowEmmCap : %d \r\n",l_cmd_PowEmmCap);
//			printf("panjang cmd_setWorkParam : %d \r\n",l_cmd_setWorkParam);
...
//				cyhal_uart_putc(&uart_obj, cmd_readDevice[i]);
//			}
//			printf("\r\n");
//			printf("Langsung dengan cyhal_uart_write:\r\n1.");
//			cyhal_uart_write(&cy_retarget_io_uart_obj, (void*) cmd_readDevice, &l_cmd_readDevice);
//			printf("\r\n2.");
//			cyhal_uart_write(&cy_retarget_io_uart_obj, (void*) cmd_setFreqRegion, &l_cmd_setFreqRegion);
//			printf("\r\n3.");
//			cyhal_uart_write(&cy_retarget_io_uart_obj, (void*) cmd_setFreqCh, &l_cmd_setFreqCh);
//			printf("\r\n4.");
//			cyhal_uart_write(&cy_retarget_io_uart_obj, (void*) cmd_autoFreqHop, &l_cmd_autoFreqHop);
//			printf("\r\n5.");
//			cyhal_uart_write(&cy_retarget_io_uart_obj, (void*) cmd_PowEmmCap, &l_cmd_PowEmmCap);
//			printf("\r\n6.");
//			cyhal_uart_write(&cy_retarget_io_uart_obj, (void*) cmd_setWorkParam, &l_cmd_setWorkParam);
//			printf("\r\n");

//			cyhal_uart_write(&uart_obj, (void*) cmd_readDevice, &l_cmd_readDevice);
//			printf("\r\n");
...
//
//			printf("%d. ",j);
//			for (size_t i = 0; i < l_cmd_setFreqRegion; i++)
//			{
//			    printf("%02X ", cmd_setFreqRegion[i]);
//			}
//			printf("\r\n");
//			j++;
//
//			printf("%d. ",j);
//			for (size_t i = 0; i < l_cmd_setFreqCh; i++)
//			{
//			    printf("%02X ", cmd_setFreqCh[i]);
//			}
//			printf("\r\n");
//			j++;
//
//			printf("%d. ",j);
//			for (size_t i = 0; i < l_cmd_autoFreqHop; i++)
//			{
//			    printf("%02X ", cmd_autoFreqHop[i]);
//			}
//			printf("\r\n");
//			j++;
//
//			printf("%d. ",j);
//			for (size_t i = 0; i < l_cmd_PowEmmCap; i++)
//			{
//			    printf("%02X ", cmd_PowEmmCap[i]);
//			}
//			printf("\r\n");
//			j++;
//
//			printf("%d. ",j);
//			for (size_t i = 0; i < l_cmd_setWorkParam; i++)
//			{
//			    printf("%02X ", cmd_setWorkParam[i]);
//			}
//			printf("\r\n");
//			j++;
			...
			cyhal_uart_write(&uart_obj, (void*) cmd_readDevice, &l_cmd_readDevice);
			cyhal_uart_write(&uart_obj, (void*) cmd_setFreqRegion, &l_cmd_setFreqRegion);
			cyhal_uart_write(&uart_obj, (void*) cmd_setFreqCh, &l_cmd_setFreqCh);
			cyhal_uart_write(&uart_obj, (void*) cmd_autoFreqHop, &l_cmd_autoFreqHop);
			cyhal_uart_write(&uart_obj, (void*) cmd_PowEmmCap, &l_cmd_PowEmmCap);
			cyhal_uart_write(&uart_obj, (void*) cmd_setWorkParam, &l_cmd_setWorkParam);
			...
			if (mode == READ_MODE)
			{
			  ...
			  // berhenti baca RFID tag
			  cyhal_uart_write(&uart_obj, (void*) cmd_stopRead, &l_cmd_stopRead);
			}
			else
			{
			  mode = READ_MODE;
			  ...
			  cyhal_uart_write(&uart_obj, (void*) cmd_startSingleRead, &l_cmd_startSingleRead);
			}
		}
    }
}
