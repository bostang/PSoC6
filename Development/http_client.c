...
//#define ANYTHINGRESOURCE					"/hw-crud/inbound?id="
//#define ANYTHINGRESOURCE1					"/hw-crud/inbound?id=0205241302472A"

// TODO: Define the Request body - dont't forget to escape your quotation marks!
#define REQUEST_BODY						"{\"data\": [{\"scanned\": true}]}"
//
...
//	uint8_t data_kirim = 0;
	uint8_t tx_buf[TX_BUF_SIZE];
	size_t tx_length = TX_BUF_SIZE;
	uint8_t variabel_kirim[TX_BUF_SIZE];
//
//	//get request body
//	data_kirim=data_acquisition_task();
//	uint8_t REQUEST_BODY= data_kirim;
//	int REQUEST_BODY_LENGTH =( sizeof( REQUEST_BODY ) - 1 );
...
//    uint8_t variabel_kirim[13] = {'8','9','9','2','7','7','9','2','5','1','4','0','5'};
	...
	char ANYTHINGRESOURCE[35];
//	snprintf(REQUEST_BODY, sizeof(REQUEST_BODY), "{\"data barcode\":[\"%s\",\"543210987654\"] }", (char*)variabel_kirim);
//	snprintf(REQUEST_BODY, sizeof(REQUEST_BODY), "{\"data barcode\":[\"%s\",\"543210987654\"]}", (char*)variabel_kirim);
//	snprintf(REQUEST_BODY, sizeof(REQUEST_BODY), "{\"data_barcode\":\[\"%s\",\"543210987654\"]}", (char*)variabel_kirim);
	snprintf(ANYTHINGRESOURCE, sizeof(ANYTHINGRESOURCE), "/hw-crud/inbound?id=%s", (char*)variabel_kirim);
...
//	{"data barcode":["8992779251405","543210987654"]}
